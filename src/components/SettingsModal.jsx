...
export default function SettingsModal({ accent, onPickAccent, onToggleTheme, onClose }) {
  return (
    <div
      onClick={onClose}
      style={{
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 22 }}>
          <div>
            ...
            <div style={{ fontSize: 13, color: 'var(--text-2)', marginTop: 2 }}>화면 테마와 포인트 컬러를 골라보세요</div>
          </div>
          <button
            onClick={onClose}
            aria-label="닫기"
